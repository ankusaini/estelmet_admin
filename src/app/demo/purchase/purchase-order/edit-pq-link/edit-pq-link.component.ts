...
@Component({
  selector: 'app-edit-pq-link',
  templateUrl: './edit-pq-link.component.html',
  styleUrls: ['./edit-pq-link.component.css']
})
export class EditPqLinkComponent implements OnInit {
