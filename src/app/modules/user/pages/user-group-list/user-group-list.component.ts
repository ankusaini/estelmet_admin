 ...
 basicSwal() {
    Swal.fire({
     ...
     if(selectedRole!='')
      ...
      let url="/users/group/getAllUserGroupByUserRoleAndStatus/"+selectedRole.value+"/APPROVED";
      
    this.userService.getAllUserByUserGroupRoleAndStatus(url).subscribe(data=>{
